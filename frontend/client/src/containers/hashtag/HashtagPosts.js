    ...
    <Layout>
      ...
      <>
          ...
          <div className="d-flex gap-5 mt-4 justify-content-center">
            <div className="h6 align-self-center fw-light mb-5 text-light">{data?.post_count} posts</div>
          </div>
          <div className="gallery ">
            ...
            to={`/${post.pk}`}
            state={{ background: location, queryName:'getPost', post:post, addArgument:null, updateCacheArgument:post.pk }}
          >
